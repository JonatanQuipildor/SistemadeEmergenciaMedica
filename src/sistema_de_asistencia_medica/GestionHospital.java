...
public class GestionHospital {
    public ArrayList<clases.generadoras.Empleado> empleados = new ArrayList<>();
    public ArrayList<clases.generadoras.Movil> moviles = new ArrayList<>();
    public ArrayList<clases.generadoras.Afiliado> afiliados = new ArrayList<>();
    private ArrayList<clases.generadoras.AsistenciaMedica> asisAfiliados = new ArrayList<>();
    private ArrayList<clases.generadoras.AsistenciaMedicaFamiliar> asisFamiliares = new ArrayList<>();
